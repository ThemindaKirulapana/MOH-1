            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
               <div class="row">
                  <div class="service-time three" style="background:#0060b1;">
                     ...
                     <h3>WHO</h3>
                     <p>World Health Organization (WHO) is the United Nations’ specialized agency for Health. </p>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="message-box">
                     ...
                     <br>
                     <h2>OUR MISSION</h2>
                     <p class="lead">To contribute to social and economic development of Sri Lanka by achieving the highest attainable health status through promotive, preventive, curative and rehabilitative services of high quality made available and accessible to people of Sri Lanka</p>
                  </div>
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="footer-text">
                     <p>©Copy Right @ MINISTRY OF HEALTH  . All Rights Reserved.</p>
